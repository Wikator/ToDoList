...
public interface ICollegeRepository : IRepository<College>
{
    ...
    /// </summary>
    /// <param name="ignoreNoneGroups">
    ///     Whether to ignore or not groups that are considered as "None". Elements that belong to
    ///     ApplicationUser will not be ignored
    /// </param>
    ...
    Task<IEnumerable<College>> GetCollegesAsync(bool ignoreNoneGroups, ApplicationUser? applicationUser = null,
    ...
    /// </summary>
    /// <typeparam name="TDataType">A datatype of field that will be used to order elements</typeparam>
    /// <param name="ignoreNoneGroups">
    ///     Whether to ignore or not groups that are considered as "None". Elements that belong to
    ///     ApplicationUser will not be ignored
    /// </param>
    ...
    /// <param name="filter">Any additional filters</param>
    /// <returns>An IEnumerable of colleges</returns>
    Task<IEnumerable<College>> GetCollegesAsync<TDataType>(bool ignoreNoneGroups,
        Expression<Func<College, TDataType>> order, ApplicationUser? applicationUser = null,
        Expression<Func<College, bool>>? filter = null);

    void RemoveCollege(College college, string wwwRootPath);
}