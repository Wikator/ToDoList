        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Group1Id = table.Column<int>(type: "int", nullable: true),
                    Group2Id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Groups_Group1Id",
                        column: x => x.Group1Id,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Groups_Group2Id",
                        column: x => x.Group2Id,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletedCollege", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Group1Id",
                table: "AspNetUsers",
                column: "Group1Id");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Group2Id",
                table: "AspNetUsers",
                column: "Group2Id");
